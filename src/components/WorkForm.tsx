...
const inputClass =
  'w-full px-4 py-3 bg-zinc-800 border border-zinc-700 rounded-lg text-white outline-none transition focus:ring-2 focus:ring-amber-500 focus:border-amber-500';
...
export default function WorkForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        <label htmlFor="experience" className="block text-sm font-medium mb-1 text-gray-300">
          Experience
        </label>
        <select
          id="experience"
