...
export const metadata: Metadata = {
  title: 'Book Now',
  description: 'Book your appointment at Conejo Valley Barber. Call (805) 719-7522 to schedule your haircut, fade, or beard trim.',
};
      ...
      <section className="py-12 bg-zinc-950">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 bg-zinc-900 rounded-2xl p-8 text-center">
            ...
            <p className="text-gray-400 mb-6">Give us a call to schedule your appointment directly.</p>
            <a
          ...
          <div className="mt-8 text-center">
            ...
            <p className="text-gray-400 text-lg">60 Houston Dr.</p>
          ...
          <div className="mt-12 text-center">
            ...
            <Link href="/contact" className="text-amber-500 font-semibold hover:text-amber-400 transition-colors">
              Contact Us →
            </Link>
          </div>
        </div>
