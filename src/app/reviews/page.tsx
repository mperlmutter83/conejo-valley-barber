...
export const metadata: Metadata = {
  title: "Leave a Review | Conejo Valley Barber",
  description: "Leave Conejo Valley Barber a review on Google or Yelp.",
};

const reviews = [
  { label: "Leave a Google Review", href: "https://g.page/r/CZDrGJLpCL1yEAE/review", kind: "google" },
  { label: "Leave a Yelp Review", href: "https://www.yelp.com/biz/conejo-valley-barber-thousand-oaks-3", kind: "yelp" },
];
    ...
    <section className="bg-white py-20 md:py-28">
      <div className="mx-auto max-w-2xl px-4 text-center">
        ...
        <p className="mb-10 text-gray-600">
          Your feedback helps others find Conejo Valley Barber and helps us keep improving.
        </p>
