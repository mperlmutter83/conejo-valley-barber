...
const SITE_DOMAIN = 'conejovalleybarber.com';
    ...
    <>
      ...
      {post.image && (
        <section className="bg-zinc-950">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <img src={post.image} alt={post.title} className="w-full rounded-xl shadow-2xl -mt-8" />
          </div>
        </section>
      )}
      ...
      <section className="py-16 bg-zinc-950">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16 bg-zinc-900 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-400 mb-6">Book your appointment at Conejo Valley Barber today.</p>
            <Link href="/book" className="inline-block bg-amber-500 text-zinc-900 px-8 py-3 rounded-lg font-semibold hover:bg-amber-400 transition-colors">
              Book Now
            </Link>
          </div>
        </div>
